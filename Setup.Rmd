...
* Become familiar with RStudio Workbench: sessions and projects
...
Navigate to [RStudio Workbench](http://spdrweb.richmond.edu:8787) http://spdrweb.richmond.edu:8787 and sign in with your netID and password. To learn more about how to use RStudio Workbench check out the official RStudio Workbench guide [here](https://docs.rstudio.com/rsw/). 

RStudio Workbench is organized around two components: sessions (think application window open on your computer) and a project bucket (think specific lesson/class within the course). As participants in this class, you will be given access to projects that correspond to our different modules. 

To pull down your own version of the projects we'll be covering in this course:

- click New Project
- click Version Control
- click Git
- Enter the Project Repository URL that I supply you (for this class the URL is: https://github.com/lloydabell4/module1)
- Give your project a name: I recommend naming your projects by module (this is Module 1)
- Select a location for your folder: I recommend creating a top level folder called DataViz and keeping all your modules in that folder

Once you have successfully created a project from Git, notice that you can click your netID Home icon on the top right of the screen to get to a home page that shows you all your current projects. We will start in the **"Module 1"** project. 

### Resources

This course relies heavily on two primary sources. 

* *R for Data Science* by Hadley Wickham and Garrett Frolemund which can be found at [https://r4ds.had.co.nz](https://r4ds.had.co.nz) (for free!)
* *Data Visualization: A Practical Introduction* by Kieran Healy which can be found at [https://socviz.co](https://socviz.co) (also for free! - see Menu button on top left)
...
4. Download the version of R you want (when in doubt, go with the latest version- at the time of this publication it is version 4.0.3).
...
<center>
![*screenshot of R console on Mac*](Images/R-gui-mac.png){#id .class width=50% height=50%}
</center>
...
RStudio is the integrated development environment (or IDE) that we’ll be using to write R code. While an IDE is not necessary for coding, it’s nice because you’ll generally have some built-in tools that will help you along the way. They contain a text editor, debugging tools, and other neat stuff.
